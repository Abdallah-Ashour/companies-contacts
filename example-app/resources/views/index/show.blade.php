                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group row mb-0">
                    <div class="col-md-9 offset-md-3">
                        <a href="{{route('index.edit', $contact->id)}}" class="btn btn-info">Edit</a>
                        <form action="{{ route('index.destroy', $contact->id) }}?redirect=index.index" method="POST"  class="d-inline">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-outline-danger">Delete</button>
                        </form>
                        <a href="{{ route("index.index")}}" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                  </div>
                </div>
              </div>
